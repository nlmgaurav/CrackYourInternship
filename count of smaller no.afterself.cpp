...
Step 4 : In void merge() while merging two arrays check if right is greater than left then its ok but if left is greater than right add total element left in right in count array where the index can be find by vector of pairs;
